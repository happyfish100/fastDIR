...
#define FDIR_SERVICE_PROTO_SET_DENTRY_SIZE_REQ      55  //modified by inode
#define FDIR_SERVICE_PROTO_SET_DENTRY_SIZE_RESP     56
#define FDIR_SERVICE_PROTO_MODIFY_DENTRY_STAT_REQ   57
#define FDIR_SERVICE_PROTO_MODIFY_DENTRY_STAT_RESP  58
#define FDIR_SERVICE_PROTO_FLOCK_DENTRY_REQ         59  //file lock
#define FDIR_SERVICE_PROTO_FLOCK_DENTRY_RESP        60
#define FDIR_SERVICE_PROTO_GETLK_DENTRY_REQ         61
#define FDIR_SERVICE_PROTO_GETLK_DENTRY_RESP        62

/* system lock for apend and ftruncate */
#define FDIR_SERVICE_PROTO_SYS_LOCK_DENTRY_REQ      63
#define FDIR_SERVICE_PROTO_SYS_LOCK_DENTRY_RESP     64
#define FDIR_SERVICE_PROTO_SYS_UNLOCK_DENTRY_REQ    65
#define FDIR_SERVICE_PROTO_SYS_UNLOCK_DENTRY_RESP   66

#define FDIR_SERVICE_PROTO_SERVICE_STAT_REQ         67
#define FDIR_SERVICE_PROTO_SERVICE_STAT_RESP        68
#define FDIR_SERVICE_PROTO_CLUSTER_STAT_REQ         69
#define FDIR_SERVICE_PROTO_CLUSTER_STAT_RESP        70
