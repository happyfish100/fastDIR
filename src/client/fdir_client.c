        ...
        const FDIRDEntryFullName *fullname, int64_t *inode)
{
    SF_CLIENT_IDEMPOTENCY_QUERY_WRAPPER(client_ctx, GET_READABLE_CONNECTION,
            NULL, fdir_client_proto_lookup_inode, fullname, inode);
}
...
{
    SF_CLIENT_IDEMPOTENCY_QUERY_WRAPPER(client_ctx, GET_READABLE_CONNECTION,
            NULL, fdir_client_proto_stat_dentry_by_path, fullname, dentry);
}
...
{
    SF_CLIENT_IDEMPOTENCY_QUERY_WRAPPER(client_ctx, GET_READABLE_CONNECTION,
            NULL, fdir_client_proto_stat_dentry_by_pname, pname, dentry);
}
